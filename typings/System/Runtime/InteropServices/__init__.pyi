...
class DllImportResolver(MulticastDelegate):
    ...
    def BeginInvoke(self, libraryName: str, assembly: Assembly, searchPath: typing.Optional[typing.Optional[DllImportSearchPath]], callback: AsyncCallback, object: typing.Any) -> IAsyncResult: ...
    def EndInvoke(self, result: IAsyncResult) -> int: ...
    def Invoke(self, libraryName: str, assembly: Assembly, searchPath: typing.Optional[typing.Optional[DllImportSearchPath]]) -> int: ...
...
class LibraryImportAttribute(Attribute):
    ...
    def StringMarshallingCustomType(self, value: typing.Optional[typing.Type[typing.Any]]) -> typing.Optional[typing.Type[typing.Any]]: ...
    @property
    def TypeId(self) -> typing.Any: ...
...
class MemoryMarshal(abc.ABC):
    @staticmethod
    def TryGetString(memory: ReadOnlyMemory_1[str], text: typing.Optional[clr.Reference[str]], start: clr.Reference[int], length: clr.Reference[int]) -> bool: ...
    ...
    class CreateFromPinnedArray_MethodGroup:
        ...
        class CreateFromPinnedArray_1(typing.Generic[CreateFromPinnedArray_1_T1]):
            ...
            def __call__(self, array: typing.Optional[Array_1[CreateFromPinnedArray_1_T]], start: int, length: int) -> Memory_1[CreateFromPinnedArray_1_T]:...
    ...
    class CreateReadOnlySpan_MethodGroup:
        ...
        class CreateReadOnlySpan_1(typing.Generic[CreateReadOnlySpan_1_T1]):
            ...
            def __call__(self, reference: typing.Optional[clr.Reference[CreateReadOnlySpan_1_T]], length: int) -> ReadOnlySpan_1[CreateReadOnlySpan_1_T]:...
    ...
    class CreateSpan_MethodGroup:
        ...
        class CreateSpan_1(typing.Generic[CreateSpan_1_T1]):
            ...
            def __call__(self, reference: typing.Optional[clr.Reference[CreateSpan_1_T]], length: int) -> Span_1[CreateSpan_1_T]:...
    ...
    class TryGetMemoryManager_MethodGroup:
        ...
        class TryGetMemoryManager_2(typing.Generic[TryGetMemoryManager_2_T1, TryGetMemoryManager_2_T2]):
            ...
            @typing.overload
            def __call__(self, memory: ReadOnlyMemory_1[TryGetMemoryManager_2_T], manager: typing.Optional[clr.Reference[TryGetMemoryManager_2_TManager]]) -> bool:...
            @typing.overload
            def __call__(self, memory: ReadOnlyMemory_1[TryGetMemoryManager_2_T], manager: typing.Optional[clr.Reference[TryGetMemoryManager_2_TManager]], start: clr.Reference[int], length: clr.Reference[int]) -> bool:...
...
class NativeLibrary(abc.ABC):
    ...
    class Load_MethodGroup:
        ...
        @typing.overload
        def __call__(self, libraryName: str, assembly: Assembly, searchPath: typing.Optional[typing.Optional[DllImportSearchPath]]) -> int:...
    ...
    class TryLoad_MethodGroup:
        ...
        @typing.overload
        def __call__(self, libraryName: str, assembly: Assembly, searchPath: typing.Optional[typing.Optional[DllImportSearchPath]], handle: clr.Reference[int]) -> bool:...
...
class NFloat(IBinaryFloatingPointIeee754_1[NFloat], IMinMaxValue_1[NFloat]):
    ...
    class Parse_MethodGroup:
        ...
        @typing.overload
        def __call__(self, s: ReadOnlySpan_1[str], style: NumberStyles = ..., provider: typing.Optional[IFormatProvider] = ...) -> NFloat:...
        @typing.overload
        def __call__(self, utf8Text: ReadOnlySpan_1[int], style: NumberStyles = ..., provider: typing.Optional[IFormatProvider] = ...) -> NFloat:...
        @typing.overload
    ...
    class TryFormat_MethodGroup:
        @typing.overload
        def __call__(self, destination: Span_1[str], charsWritten: clr.Reference[int], format: ReadOnlySpan_1[str] = ..., provider: typing.Optional[IFormatProvider] = ...) -> bool:...
        @typing.overload
        def __call__(self, utf8Destination: Span_1[int], bytesWritten: clr.Reference[int], format: ReadOnlySpan_1[str] = ..., provider: typing.Optional[IFormatProvider] = ...) -> bool:...
    ...
    class TryParse_MethodGroup:
        ...
        @typing.overload
        def __call__(self, s: ReadOnlySpan_1[str], provider: typing.Optional[IFormatProvider], result: clr.Reference[NFloat]) -> bool:...
        @typing.overload
        def __call__(self, utf8Text: ReadOnlySpan_1[int], provider: typing.Optional[IFormatProvider], result: clr.Reference[NFloat]) -> bool:...
        @typing.overload
        def __call__(self, s: typing.Optional[str], provider: typing.Optional[IFormatProvider], result: clr.Reference[NFloat]) -> bool:...
        @typing.overload
        def __call__(self, s: ReadOnlySpan_1[str], style: NumberStyles, provider: typing.Optional[IFormatProvider], result: clr.Reference[NFloat]) -> bool:...
        @typing.overload
        def __call__(self, utf8Text: ReadOnlySpan_1[int], style: NumberStyles, provider: typing.Optional[IFormatProvider], result: clr.Reference[NFloat]) -> bool:...
        @typing.overload
        def __call__(self, s: typing.Optional[str], style: NumberStyles, provider: typing.Optional[IFormatProvider], result: clr.Reference[NFloat]) -> bool:...
