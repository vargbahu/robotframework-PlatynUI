...
class Utf8(abc.ABC):
    ...
    class TryWrite_MethodGroup:
        ...
        @typing.overload
        def __call__(self, destination: Span_1[int], provider: typing.Optional[IFormatProvider], handler: clr.Reference[Utf8.TryWriteInterpolatedStringHandler], bytesWritten: clr.Reference[int]) -> bool:...


    class TryWriteInterpolatedStringHandler:
        @typing.overload
        def __init__(self, literalLength: int, formattedCount: int, destination: Span_1[int], provider: typing.Optional[IFormatProvider], shouldAppend: clr.Reference[bool]) -> None: ...
        @typing.overload
        ...
        class AppendFormatted_MethodGroup:
            ...
            class AppendFormatted_1(typing.Generic[AppendFormatted_1_T1]):
                ...
                @typing.overload
                def __call__(self, value: AppendFormatted_1_T, alignment: int, format: typing.Optional[str]) -> bool:...
            ...
            @typing.overload
            def __call__(self, utf8Value: ReadOnlySpan_1[int], alignment: int = ..., format: typing.Optional[str] = ...) -> bool:...
            @typing.overload
            def __call__(self, value: ReadOnlySpan_1[str], alignment: int = ..., format: typing.Optional[str] = ...) -> bool:...
            @typing.overload
            def __call__(self, value: typing.Optional[str], alignment: int = ..., format: typing.Optional[str] = ...) -> bool:...
            @typing.overload
            def __call__(self, value: typing.Optional[typing.Any], alignment: int = ..., format: typing.Optional[str] = ...) -> bool:...
