...
class DecoderFallbackException(ArgumentException):
    ...
    @typing.overload
    def __init__(self, message: typing.Optional[str], bytesUnknown: typing.Optional[Array_1[int]], index: int) -> None: ...
    @typing.overload
...
class StringBuilder(ISerializable):
    ...
    class Append_MethodGroup:
        ...
        @typing.overload
        def __call__(self, provider: typing.Optional[IFormatProvider], handler: clr.Reference[StringBuilder.AppendInterpolatedStringHandler]) -> StringBuilder:...
        @typing.overload
    ...
    class AppendFormat_MethodGroup:
        ...
        class AppendFormat_1(typing.Generic[AppendFormat_1_T1]):
            ...
            def __call__(self, provider: typing.Optional[IFormatProvider], format: CompositeFormat, arg0: typing.Optional[AppendFormat_1_TArg0]) -> StringBuilder:...
        ...
        class AppendFormat_2(typing.Generic[AppendFormat_2_T1, AppendFormat_2_T2]):
            ...
            def __call__(self, provider: typing.Optional[IFormatProvider], format: CompositeFormat, arg0: typing.Optional[AppendFormat_2_TArg0], arg1: typing.Optional[AppendFormat_2_TArg1]) -> StringBuilder:...
        ...
        class AppendFormat_3(typing.Generic[AppendFormat_3_T1, AppendFormat_3_T2, AppendFormat_3_T3]):
            ...
            def __call__(self, provider: typing.Optional[IFormatProvider], format: CompositeFormat, arg0: typing.Optional[AppendFormat_3_TArg0], arg1: typing.Optional[AppendFormat_3_TArg1], arg2: typing.Optional[AppendFormat_3_TArg2]) -> StringBuilder:...
        ...
        @typing.overload
        def __call__(self, format: str, arg0: typing.Optional[typing.Any], arg1: typing.Optional[typing.Any]) -> StringBuilder:...
        @typing.overload
        def __call__(self, provider: typing.Optional[IFormatProvider], format: str, args: Array_1[typing.Any]) -> StringBuilder:...
        @typing.overload
        def __call__(self, provider: typing.Optional[IFormatProvider], format: str, arg0: typing.Optional[typing.Any]) -> StringBuilder:...
        @typing.overload
        def __call__(self, provider: typing.Optional[IFormatProvider], format: CompositeFormat, args: Array_1[typing.Any]) -> StringBuilder:...
        @typing.overload
        def __call__(self, provider: typing.Optional[IFormatProvider], format: CompositeFormat, args: ReadOnlySpan_1[typing.Any]) -> StringBuilder:...
        @typing.overload
        def __call__(self, format: str, arg0: typing.Optional[typing.Any], arg1: typing.Optional[typing.Any], arg2: typing.Optional[typing.Any]) -> StringBuilder:...
        @typing.overload
        def __call__(self, provider: typing.Optional[IFormatProvider], format: str, arg0: typing.Optional[typing.Any], arg1: typing.Optional[typing.Any]) -> StringBuilder:...
        @typing.overload
        def __call__(self, provider: typing.Optional[IFormatProvider], format: str, arg0: typing.Optional[typing.Any], arg1: typing.Optional[typing.Any], arg2: typing.Optional[typing.Any]) -> StringBuilder:...
    ...
    class AppendJoin_MethodGroup:
        ...
        class AppendJoin_1(typing.Generic[AppendJoin_1_T1]):
            ...
            def __call__(self, separator: typing.Optional[str], values: IEnumerable_1[AppendJoin_1_T]) -> StringBuilder:...
    ...
    class Insert_MethodGroup:
        ...
        @typing.overload
        def __call__(self, index: int, value: typing.Optional[Array_1[str]], startIndex: int, charCount: int) -> StringBuilder:...
    ...
    class AppendInterpolatedStringHandler:
        ...
        @typing.overload
        def __init__(self, literalLength: int, formattedCount: int, stringBuilder: StringBuilder, provider: typing.Optional[IFormatProvider]) -> None: ...
        ...
        class AppendFormatted_MethodGroup:
            ...
            class AppendFormatted_1(typing.Generic[AppendFormatted_1_T1]):
                ...
                @typing.overload
                def __call__(self, value: AppendFormatted_1_T, alignment: int, format: typing.Optional[str]) -> None:...
            ...
            @typing.overload
            def __call__(self, value: ReadOnlySpan_1[str], alignment: int = ..., format: typing.Optional[str] = ...) -> None:...
            @typing.overload
            def __call__(self, value: typing.Optional[str], alignment: int = ..., format: typing.Optional[str] = ...) -> None:...
            @typing.overload
            def __call__(self, value: typing.Optional[typing.Any], alignment: int = ..., format: typing.Optional[str] = ...) -> None:...
