...
class CompareInfo(IDeserializationCallback):
    ...
    class Compare_MethodGroup:
        ...
        @typing.overload
        def __call__(self, string1: typing.Optional[str], string2: typing.Optional[str], options: CompareOptions) -> int:...
        @typing.overload
        def __call__(self, string1: typing.Optional[str], offset1: int, string2: typing.Optional[str], offset2: int) -> int:...
        @typing.overload
        def __call__(self, string1: typing.Optional[str], offset1: int, string2: typing.Optional[str], offset2: int, options: CompareOptions) -> int:...
        @typing.overload
        def __call__(self, string1: typing.Optional[str], offset1: int, length1: int, string2: typing.Optional[str], offset2: int, length2: int) -> int:...
        @typing.overload
        def __call__(self, string1: typing.Optional[str], offset1: int, length1: int, string2: typing.Optional[str], offset2: int, length2: int, options: CompareOptions) -> int:...
...
class CultureNotFoundException(ArgumentException):
    ...
    @typing.overload
    def __init__(self, message: typing.Optional[str], invalidCultureId: int, innerException: typing.Optional[Exception]) -> None: ...
    @typing.overload
    def __init__(self, message: typing.Optional[str], invalidCultureName: typing.Optional[str], innerException: typing.Optional[Exception]) -> None: ...
    @typing.overload
    def __init__(self, paramName: typing.Optional[str], invalidCultureId: int, message: typing.Optional[str]) -> None: ...
    @typing.overload
    def __init__(self, paramName: typing.Optional[str], invalidCultureName: typing.Optional[str], message: typing.Optional[str]) -> None: ...
    @typing.overload
