...
class MemoryHandle(IDisposable):
    def __init__(self, pointer: clr.Reference[None], handle: GCHandle = ..., pinnable: typing.Optional[IPinnable] = ...) -> None: ...
    @property
...
class ReadOnlySpanAction_2(typing.Generic[ReadOnlySpanAction_2_T, ReadOnlySpanAction_2_TArg], MulticastDelegate):
    ...
    def BeginInvoke(self, span: ReadOnlySpan_1[ReadOnlySpanAction_2_T], arg: typing.Optional[ReadOnlySpanAction_2_TArg], callback: AsyncCallback, object: typing.Any) -> IAsyncResult: ...
    def EndInvoke(self, result: IAsyncResult) -> None: ...
    def Invoke(self, span: ReadOnlySpan_1[ReadOnlySpanAction_2_T], arg: typing.Optional[ReadOnlySpanAction_2_TArg]) -> None: ...
...
class SpanAction_2(typing.Generic[SpanAction_2_T, SpanAction_2_TArg], MulticastDelegate):
    ...
    @property
    def Target(self) -> typing.Optional[typing.Any]: ...
    def BeginInvoke(self, span: Span_1[SpanAction_2_T], arg: typing.Optional[SpanAction_2_TArg], callback: AsyncCallback, object: typing.Any) -> IAsyncResult: ...
    def EndInvoke(self, result: IAsyncResult) -> None: ...
