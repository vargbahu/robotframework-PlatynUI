...
class IndentedTextWriter(TextWriter):
    ...
    class Write_MethodGroup:
        ...
        @typing.overload
        def __call__(self, format: str, arg0: typing.Optional[typing.Any], arg1: typing.Optional[typing.Any]) -> None:...
    ...
    class WriteAsync_MethodGroup:
        ...
        @typing.overload
        def __call__(self, value: typing.Optional[StringBuilder], cancellationToken: CancellationToken = ...) -> Task:...
        @typing.overload
