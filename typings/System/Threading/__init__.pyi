...
class AbandonedMutexException(SystemException):
    ...
    @typing.overload
    def __init__(self, message: typing.Optional[str], inner: typing.Optional[Exception], location: int, handle: typing.Optional[WaitHandle]) -> None: ...
    @typing.overload
...
class AsyncLocal_1(typing.Generic[AsyncLocal_1_T]):
    ...
    def __init__(self) -> None: ...
    @typing.overload
    def __init__(self, valueChangedHandler: typing.Optional[Action_1[AsyncLocalValueChangedArgs_1[AsyncLocal_1_T]]]) -> None: ...
    @property
...
class CancellationToken(IEquatable_1[CancellationToken]):
    ...
    class Register_MethodGroup:
        ...
        @typing.overload
        def __call__(self, callback: Action_2[typing.Any, CancellationToken], state: typing.Optional[typing.Any]) -> CancellationTokenRegistration:...
        @typing.overload
        def __call__(self, callback: Action_1[typing.Any], state: typing.Optional[typing.Any]) -> CancellationTokenRegistration:...
        @typing.overload
        def __call__(self, callback: Action, useSynchronizationContext: bool) -> CancellationTokenRegistration:...
        @typing.overload
        def __call__(self, callback: Action_1[typing.Any], state: typing.Optional[typing.Any], useSynchronizationContext: bool) -> CancellationTokenRegistration:...
...
class CompressedStack(ISerializable):
    ...
    @staticmethod
    def Run(compressedStack: CompressedStack, callback: ContextCallback, state: typing.Optional[typing.Any]) -> None: ...
...
class ContextCallback(MulticastDelegate):
    ...
    def BeginInvoke(self, state: typing.Optional[typing.Any], callback: AsyncCallback, object: typing.Any) -> IAsyncResult: ...
...
class EventWaitHandle(WaitHandle):
    ...
    @typing.overload
    def __init__(self, initialState: bool, mode: EventResetMode, name: typing.Optional[str], createdNew: clr.Reference[bool]) -> None: ...
    @property
    def Handle(self) -> int: ...
    @Handle.setter
    def Handle(self, value: int) -> int: ...
...
class ExecutionContext(ISerializable, IDisposable):
    ...
    @staticmethod
    def Run(executionContext: ExecutionContext, callback: ContextCallback, state: typing.Optional[typing.Any]) -> None: ...
    @staticmethod
...
class Interlocked(abc.ABC):
    ...
    class CompareExchange_MethodGroup:
        ...
        class CompareExchange_1(typing.Generic[CompareExchange_1_T1]):
            ...
            def __call__(self, location1: typing.Optional[clr.Reference[CompareExchange_1_T]], value: typing.Optional[CompareExchange_1_T], comparand: typing.Optional[CompareExchange_1_T]) -> CompareExchange_1_T:...
        ...
        @typing.overload
        def __call__(self, location1: typing.Optional[clr.Reference[typing.Any]], value: typing.Optional[typing.Any], comparand: typing.Optional[typing.Any]) -> typing.Any:...
    ...
    class Exchange_MethodGroup:
        ...
        class Exchange_1(typing.Generic[Exchange_1_T1]):
            ...
            def __call__(self, location1: typing.Optional[clr.Reference[Exchange_1_T]], value: typing.Optional[Exchange_1_T]) -> Exchange_1_T:...
        ...
        @typing.overload
        def __call__(self, location1: typing.Optional[clr.Reference[typing.Any]], value: typing.Optional[typing.Any]) -> typing.Any:...
...
class LazyInitializer(abc.ABC):
    ...
    class EnsureInitialized_MethodGroup:
        ...
        class EnsureInitialized_1(typing.Generic[EnsureInitialized_1_T1]):
            ...
            @typing.overload
            def __call__(self, target: typing.Optional[clr.Reference[EnsureInitialized_1_T]], initialized: clr.Reference[bool], syncLock: typing.Optional[clr.Reference[typing.Any]]) -> EnsureInitialized_1_T:...
            @typing.overload
            def __call__(self, target: clr.Reference[EnsureInitialized_1_T], syncLock: typing.Optional[clr.Reference[typing.Any]], valueFactory: Func_1[EnsureInitialized_1_T]) -> EnsureInitialized_1_T:...
            @typing.overload
            def __call__(self, target: typing.Optional[clr.Reference[EnsureInitialized_1_T]], initialized: clr.Reference[bool], syncLock: typing.Optional[clr.Reference[typing.Any]], valueFactory: Func_1[EnsureInitialized_1_T]) -> EnsureInitialized_1_T:...
...
class Overlapped:
    ...
    class Pack_MethodGroup:
        ...
        @typing.overload
        def __call__(self, iocb: typing.Optional[IOCompletionCallback], userData: typing.Optional[typing.Any]) -> clr.Reference[NativeOverlapped]:...
...
class ParameterizedThreadStart(MulticastDelegate):
    ...
    @property
    def Target(self) -> typing.Optional[typing.Any]: ...
    def BeginInvoke(self, obj: typing.Optional[typing.Any], callback: AsyncCallback, object: typing.Any) -> IAsyncResult: ...
    def EndInvoke(self, result: IAsyncResult) -> None: ...
...
class PreAllocatedOverlapped(IDisposable):
    def __init__(self, callback: IOCompletionCallback, state: typing.Optional[typing.Any], pinData: typing.Optional[typing.Any]) -> None: ...
    def Dispose(self) -> None: ...
    @staticmethod
    def UnsafeCreate(callback: IOCompletionCallback, state: typing.Optional[typing.Any], pinData: typing.Optional[typing.Any]) -> PreAllocatedOverlapped: ...
...
class Semaphore(WaitHandle):
    ...
    @typing.overload
    def __init__(self, initialCount: int, maximumCount: int, name: typing.Optional[str], createdNew: clr.Reference[bool]) -> None: ...
    @property
    def Handle(self) -> int: ...
    @Handle.setter
    def Handle(self, value: int) -> int: ...
...
class Thread(CriticalFinalizerObject):
    ...
    class VolatileWrite_MethodGroup:
        ...
        @typing.overload
        def __call__(self, address: typing.Optional[clr.Reference[typing.Any]], value: typing.Optional[typing.Any]) -> None:...
...
class ThreadPool(abc.ABC):
    ...
    class QueueUserWorkItem_MethodGroup:
        ...
        class QueueUserWorkItem_1(typing.Generic[QueueUserWorkItem_1_T1]):
            ...
            def __call__(self, callBack: Action_1[QueueUserWorkItem_1_TState], state: typing.Optional[QueueUserWorkItem_1_TState], preferLocal: bool) -> bool:...
    ...
    class RegisterWaitForSingleObject_MethodGroup:
        @typing.overload
        def __call__(self, waitObject: WaitHandle, callBack: WaitOrTimerCallback, state: typing.Optional[typing.Any], millisecondsTimeOutInterval: int, executeOnlyOnce: bool) -> RegisteredWaitHandle:...
        ...
        @typing.overload
        def __call__(self, waitObject: WaitHandle, callBack: WaitOrTimerCallback, state: typing.Optional[typing.Any], timeout: TimeSpan, executeOnlyOnce: bool) -> RegisteredWaitHandle:...
    ...
    class UnsafeQueueUserWorkItem_MethodGroup:
        ...
        class UnsafeQueueUserWorkItem_1(typing.Generic[UnsafeQueueUserWorkItem_1_T1]):
            ...
            def __call__(self, callBack: Action_1[UnsafeQueueUserWorkItem_1_TState], state: typing.Optional[UnsafeQueueUserWorkItem_1_TState], preferLocal: bool) -> bool:...
...
class ThreadPoolBoundHandle(IDisposable):
    ...
    def UnsafeAllocateNativeOverlapped(self, callback: IOCompletionCallback, state: typing.Optional[typing.Any], pinData: typing.Optional[typing.Any]) -> clr.Reference[NativeOverlapped]: ...
    ...
    class AllocateNativeOverlapped_MethodGroup:
        ...
        @typing.overload
        def __call__(self, callback: IOCompletionCallback, state: typing.Optional[typing.Any], pinData: typing.Optional[typing.Any]) -> clr.Reference[NativeOverlapped]:...
...
class Timer(MarshalByRefObject, ITimer):
    ...
    @typing.overload
    def __init__(self, callback: TimerCallback, state: typing.Optional[typing.Any], dueTime: int, period: int) -> None: ...
    @typing.overload
    def __init__(self, callback: TimerCallback, state: typing.Optional[typing.Any], dueTime: TimeSpan, period: TimeSpan) -> None: ...
    @classmethod
    @property
...
class Volatile(abc.ABC):
    ...
    class Write_MethodGroup:
        ...
        class Write_1(typing.Generic[Write_1_T1]):
            ...
            def __call__(self, location: typing.Optional[clr.Reference[Write_1_T]], value: typing.Optional[Write_1_T]) -> None:...
...
class WaitOrTimerCallback(MulticastDelegate):
    ...
    @property
    def Target(self) -> typing.Optional[typing.Any]: ...
    def BeginInvoke(self, state: typing.Optional[typing.Any], timedOut: bool, callback: AsyncCallback, object: typing.Any) -> IAsyncResult: ...
    def EndInvoke(self, result: IAsyncResult) -> None: ...
