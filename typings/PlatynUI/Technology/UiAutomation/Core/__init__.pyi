...
from PlatynUI.Technology.UiAutomation.Client import IUIAutomationTreeWalker, IUIAutomationElement, IUIAutomation, tagRECT
from PlatynUI.Technology.UiAutomation import Point, Rect
...
class Automation:
    ...
    @staticmethod
    def CompareElements(e1: typing.Optional[IUIAutomationElement], e2: typing.Optional[IUIAutomationElement]) -> bool: ...
    @staticmethod
    ...
    class GetCurrentPattern_MethodGroup:
        def __getitem__(self, t:typing.Type[GetCurrentPattern_1_T1]) -> GetCurrentPattern_1[GetCurrentPattern_1_T1]: ...
    ...
    class TryGetCachedPattern_MethodGroup:
        def __getitem__(self, t:typing.Type[TryGetCachedPattern_1_T1]) -> TryGetCachedPattern_1[TryGetCachedPattern_1_T1]: ...
        ...
        class TryGetCachedPattern_1(typing.Generic[TryGetCachedPattern_1_T1]):
            ...
            def __call__(self, element: IUIAutomationElement, pattern: typing.Optional[clr.Reference[TryGetCachedPattern_1_T]]) -> bool:...
    ...
    class TryGetCurrentPattern_MethodGroup:
        def __getitem__(self, t:typing.Type[TryGetCurrentPattern_1_T1]) -> TryGetCurrentPattern_1[TryGetCurrentPattern_1_T1]: ...
        ...
        class TryGetCurrentPattern_1(typing.Generic[TryGetCurrentPattern_1_T1]):
            ...
            def __call__(self, element: IUIAutomationElement, pattern: typing.Optional[clr.Reference[TryGetCurrentPattern_1_T]]) -> bool:...
...
class UiAutomationElementExtensions(abc.ABC):
    ...
    @staticmethod
    def EnumerateChildren(element: typing.Optional[IUIAutomationElement], walker: typing.Optional[IUIAutomationTreeWalker], findVirtual: bool = ...) -> IEnumerable_1[IUIAutomationElement]: ...
    @staticmethod
    ...
    class TryGetCachedPattern_MethodGroup:
        ...
        TryGetCachedPattern_1_T1 = typing.TypeVar('TryGetCachedPattern_1_T1')
        class TryGetCachedPattern_1(typing.Generic[TryGetCachedPattern_1_T1]):
            TryGetCachedPattern_1_T = UiAutomationElementExtensions.TryGetCachedPattern_MethodGroup.TryGetCachedPattern_1_T1
            def __call__(self, element: IUIAutomationElement, pattern: typing.Optional[clr.Reference[TryGetCachedPattern_1_T]]) -> bool:...
    ...
    class TryGetCurrentPattern_MethodGroup:
        ...
        TryGetCurrentPattern_1_T1 = typing.TypeVar('TryGetCurrentPattern_1_T1')
        class TryGetCurrentPattern_1(typing.Generic[TryGetCurrentPattern_1_T1]):
            TryGetCurrentPattern_1_T = UiAutomationElementExtensions.TryGetCurrentPattern_MethodGroup.TryGetCurrentPattern_1_T1
            def __call__(self, element: IUIAutomationElement, pattern: typing.Optional[clr.Reference[TryGetCurrentPattern_1_T]]) -> bool:...
