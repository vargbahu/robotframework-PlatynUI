...
# mypy: ignore-errors
import typing, abc
from PlatynUI.Runtime.Core import INode, IAttribute, Keycode, MouseButton
...
class Finder(abc.ABC):
    ...
    @staticmethod
    def FindNodes(parent: typing.Optional[INode], xpath: str, findVirtual: bool = ...) -> IList_1[INode]: ...
    @staticmethod
...
class Mouse:
    ...
    @staticmethod
    def Press(button: MouseButton) -> None: ...
    @staticmethod
    def Release(button: MouseButton) -> None: ...
