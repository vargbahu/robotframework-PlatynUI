namespace WpfTestApp.Pages.Lists
{
    ...
    public class ListsPageViewModel : TabPageBase
    {
        ...
        private ObservableCollection<string> _readonlyComboBoxItems = new ObservableCollection<string>
        {
            "Monday",
            "Tuesday",
            "Wednesday",
        ...
        private ObservableCollection<string> _simpleComboBoxItems = new ObservableCollection<string>
        {
            "Monday",
            "Tuesday",
            "Wednesday",
        ...
        private ObservableCollection<string> _simpleEditableComboBoxItems = new ObservableCollection<string>
        {
            "Monday",
            "Tuesday",
            "Wednesday",
        ...
        private ObservableCollection<string> _simpleListBoxItems = new ObservableCollection<string>
        {
            "Monday",
            "Tuesday",
            "Wednesday",
        ...
        private ObservableCollection<string> _simpleVirtualizedListBoxItems = new ObservableCollection<string>
        {
            "Monday",
            "Tuesday",
            "Wednesday",
        ...
        private ObservableCollection<string> _virtualizedMultiSelectableListBoxItems = new ObservableCollection<string>
        {
            "Monday",
            "Tuesday",
            "Wednesday",
